...
public class PRAK101_2310817110006_ABS {
	public static void main(String[] args) {
		...
		System.out.printf("Nama Lengkap %s, Lahir di %s pada Tanggal %d %s %d Tinggi Badan %.0f cm dan Berat Badan %.2f kilogram",
		                  nama, tempatLahir, tanggalLahir, namaBulan[bulanLahir], tahunLahir, tinggiBadan, beratBadan);
	}
}